(function() {
  ...
  _.memoize = function(func) {
    var result;
    var alreadyCalledArgs = [];

    return function() {
      var args = Array.prototype.slice.call(arguments);
      var currentArgs = JSON.stringify(args);

      if (alreadyCalledArgs.indexOf(currentArgs) === -1) {
        result = func.apply(this, args);
        alreadyCalledArgs.push(currentArgs);
      }
      return result;
    };
  };
